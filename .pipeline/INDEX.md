...
- [Cycle 索引](cycles/INDEX.md)：当前 active Cycle 为 C19 VSPi Subagent Runtime 审计与 v2 Plan（M5 已完成，S2 实施授权因额度原因推迟；未修改源码）；C18 Windows 自更新安装器修复已发布 v1.1.1，等待原 Windows 机器实机复核；C17 前缀缓存与 DeepSeek Harness 适配已发布 v1.1.0。
