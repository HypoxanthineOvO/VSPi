...
- [Memory 记录](memory/records/)：129 条合法 decision/feedback/requirement/preference Record，按 scope 分组；C07 corrective decision supersede 旧 revision 0 记录；v0.6.0 release outcome 已记录。
