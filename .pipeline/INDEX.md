...
- [Memory 记录](memory/records/)：135 条合法 decision/feedback/requirement/preference Record，按 scope 分组；C07 corrective decision supersede 旧 revision 0 记录；v0.6.0-v0.6.2 release outcome、Windows named-pipe lease 与 R8 TUI 行为要求已记录。
