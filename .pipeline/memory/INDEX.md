...
| --- | --- | --- | --- | --- | --- |
| decision-0893f7eb55067ac1cb0180c59e7259f0 | inactive (superseded) | decision | cycle:vspi-tui-v1 | cycle.vspi-tui-v1.plan | decision-b044b80dda4ec71a62b5125962d23b3a |
...
| decision-5a7bb7573abaa22b1e23d58c51980dad | inactive (superseded) | decision | cycle:vspi-v0-2-0-workflow-integration | cycle.vspi-v0-2-0-workflow-integration.plan | decision-ff351e9d4433699ce4b2d64ffea2bc3d |
| decision-62c857d1de35f40189c98a9a9a542bc5 | active | decision | project:VSPi | decision.vspi.post-0.2.5-feature-order | - |
| decision-67927170f6d59e15a12ea00f7b92ed69 | inactive (superseded) | decision | cycle:vspi-tui-v1 | cycle.vspi-tui-v1.plan | - |
...
| decision-a023de2288f3238875f20e04f70dc948 | inactive (superseded) | decision | cycle:vspi-v0-2-0-workflow-integration | cycle.vspi-v0-2-0-workflow-integration.plan | decision-99c581d354bfa95e19d3f16da15f5c48 |
| decision-a82b0e062b7ad9ffef82d6ce5e3b7d43 | active | decision | project:VSPi | decision.vspi.external-session-import-detail | - |
| decision-a85be902c538b0b1b552cbf35f8dbe7d | active | decision | project:VSPi | decision.vspi.release-train.v0.6.0 | - |
| decision-a9f8f997782c21e59dcbdc7ffde3b766 | inactive (superseded) | decision | cycle:vspi-terminal-mock-recovery | cycle.vspi-terminal-mock-recovery.plan | decision-d3cdb7ff76556bda0c4812e50be39d24 |
| decision-ab205a44cb46e78bc6766831ffaa98c3 | active | decision | goal:vspi-persistent-goal-runner | goal.vspi-persistent-goal-runner.plan | decision-6e1c2b538e3e79851203f5e376f97975 |
| decision-af0dffd0b340a15784ba86a694c13b28 | inactive (superseded) | decision | goal:vspi-live-run-control | goal.vspi-live-run-control.plan | - |
| decision-b044b80dda4ec71a62b5125962d23b3a | inactive (superseded) | decision | cycle:vspi-tui-v1 | cycle.vspi-tui-v1.plan | decision-67927170f6d59e15a12ea00f7b92ed69 |
| decision-b37683552d11450914284f2e7321d46e | inactive (superseded) | decision | cycle:vspi-v0-1-0-usability | cycle.vspi-v0-1-0-usability.plan | - |
| decision-b8914dccf4f709762381abeb08e0d370 | inactive (superseded) | decision | cycle:vspi-v0-2-0-workflow-integration | cycle.vspi-v0-2-0-workflow-integration.plan | decision-5a7bb7573abaa22b1e23d58c51980dad |
...
| decision-dadcdf82568a01d80eeccfe8ee8432db | active | decision | project:VSPi | decision.vspi.mcp-tool-exposure | - |
| decision-deccd6104c4cd9fb7b03c6a041a48556 | active | decision | goal:vspi-subagent-teams-goal | goal.vspi-subagent-teams-goal.plan | - |
| decision-e51df954eb0778a9ff307959e81c94f6 | inactive (superseded) | decision | goal:vspi-persistent-goal-runner | goal.vspi-persistent-goal-runner.plan | decision-347778f17c1ed58fcea811fd2175c413 |
| decision-edcc60dceb747cf67ae8e64d3fba5a39 | active | decision | cycle:vspi-subagent-teams | cycle.vspi-subagent-teams.plan | decision-76faed9d5251e6a4aa4a5ae9a4daefa5 |
| decision-ee559d9b1df2d45707b52c80e60f876b | inactive (superseded) | decision | cycle:vspi-v0-2-0-workflow-integration | cycle.vspi-v0-2-0-workflow-integration.plan | - |
| decision-f0677f2e7c84f47ee410ea2a34954434 | inactive (superseded) | decision | goal:vspi-live-run-control | goal.vspi-live-run-control.plan | decision-c333e5efe46be866faf28757c94176ad |
| decision-fc08c040b86a57bf2800480f6c5e4baa | active | decision | project:VSPi | decision.vspi.skill-install-default-scope | - |
| decision-fef54ead775588f8899dba4b09dd65fd | active | decision | project:VSPi | decision.vspi.pty-debug-playbook | - |
| decision-ff351e9d4433699ce4b2d64ffea2bc3d | inactive (superseded) | decision | cycle:vspi-v0-2-0-workflow-integration | cycle.vspi-v0-2-0-workflow-integration.plan | decision-a023de2288f3238875f20e04f70dc948 |
| feedback-0209cf10017937b9ce7356aaca5eece2 | active | feedback | cycle:vspi-v0-1-0-usability | cycle.vspi-v0-1-0-usability.feedback.00b9bb4cff9999bd | - |
| feedback-02a51cd5ae8a278313abf9136d3e6ce6 | active | feedback | cycle:vspi-terminal-mock-recovery | cycle.vspi-terminal-mock-recovery.feedback.ac4ac8b73e5bad27 | - |
...
| feedback-237bcdb65718f5b6164c08ac47cdc94d | active | feedback | cycle:vspi-v0-2-0-workflow-integration | cycle.vspi-v0-2-0-workflow-integration.feedback.dc3a0f94d1467e35 | - |
| feedback-286ce0c0ce667f86cdf15febe3fc54eb | active | feedback | project:VSPi | feedback.vspi.release-ledger.v0.2.1-v0.2.7 | - |
| feedback-2888bdf80dca47139286cc5d09dc1b78 | active | feedback | cycle:vspi-v0-2-0-workflow-integration | cycle.vspi-v0-2-0-workflow-integration.feedback.e7ded37362b1722e | - |
| feedback-2975a350a7865f4fc29f1218b5bff36d | active | feedback | cycle:vspi-v0-2-0-workflow-integration | cycle.vspi-v0-2-0-workflow-integration.feedback.244a565c768b3033 | - |
| feedback-2dc39de0dbbb77493cac3135e83d2a25 | active | feedback | goal:vspi-live-run-control | goal.vspi-live-run-control.feedback.3f4c4ce3670b5fb2 | - |
| feedback-2fafe8c7cd60474907edaf41373b844e | active | feedback | goal:vspi-persistent-goal-runner | goal.vspi-persistent-goal-runner.feedback.a44abc08a4934317 | - |
| feedback-3082d500ee579c89e32e3594ff56b38f | active | feedback | goal:vspi-live-run-control | goal.vspi-live-run-control.feedback.771996a5e1a5efc7 | - |
| feedback-309edec7a60dd4c1b493b13fc7e46c81 | active | feedback | cycle:vspi-tui-v1 | cycle.vspi-tui-v1.feedback.ff40cfb6c4e06804 | - |
| feedback-36a85019af5becf313cfafda0ffc58bb | inactive (superseded) | feedback | project:VSPi | feedback.vspi.status-layout-fixed-tracks | feedback-db31efd26e2215b19a90826d64584e69 |
| feedback-3a97aa13a519aea258d8a397676b8499 | active | feedback | goal:vspi-persistent-goal-runner | goal.vspi-persistent-goal-runner.feedback.7222710813ae7c48 | - |
| feedback-3e32c4ab8e560f29f532662278de4d87 | active | feedback | cycle:vspi-tui-v1 | cycle.vspi-tui-v1.feedback.a4536cf5a20774de | - |
| feedback-40a6180c65bcf925d1cd8c783fb936db | active | feedback | cycle:vspi-terminal-mock-recovery | cycle.vspi-terminal-mock-recovery.feedback.b0f8b724ad3bebdd | - |
| feedback-44198afddd97a657ea2cdab8cd574ed3 | inactive (superseded) | feedback | delivery:vspi-v0-1-0-usability | feedback.vspi.status-layout-fixed-tracks | - |
| feedback-4948393d7732416a0ce0a032a4aefcaf | active | feedback | cycle:vspi-v0-2-0-workflow-integration | cycle.vspi-v0-2-0-workflow-integration.feedback.048085098adea83d | - |
| feedback-4d078eb912144be599cb51900961d07a | active | feedback | cycle:vspi-terminal-mock-recovery | cycle.vspi-terminal-mock-recovery.feedback.6a33fc1435e7074c | - |
| feedback-4f080470422976136f494de38869d7b3 | active | feedback | cycle:vspi-terminal-mock-recovery | cycle.vspi-terminal-mock-recovery.feedback.f0944802c5537ff5 | - |
| feedback-57c0bec22f6e4b1f92bb7f3a9f277bc0 | active | feedback | goal:vspi-persistent-goal-runner | goal.vspi-persistent-goal-runner.feedback.0564e746519681aa | - |
| feedback-5842cb8274a7086532d7a7c6c4be5e38 | active | feedback | cycle:vspi-terminal-mock-recovery | cycle.vspi-terminal-mock-recovery.feedback.6cd56e1b300161ec | - |
| feedback-60093381731f723a648627fef2347991 | active | feedback | project:VSPi | feedback.vspi.release-ledger.v0.3.0-v0.3.7 | - |
| feedback-66872838bdbce1337743646dc69c7c2f | active | feedback | goal:vspi-live-run-control | goal.vspi-live-run-control.feedback.bf4a41fa17dcef69 | - |
...
| feedback-7da490d7b5b02157c2be6d408c609c43 | active | feedback | project:VSPi | feedback.vspi.release-ledger.v0.1.0 | - |
| feedback-8514d7f0d8a05202dfb6508c06d00248 | active | feedback | cycle:vspi-tui-v1 | cycle.vspi-tui-v1.feedback.59ca3879c2754ad1 | - |
| feedback-89ed9f5b6872a5259a96a681d88ae282 | active | feedback | goal:vspi-live-run-control | goal.vspi-live-run-control.feedback.557a36ec9b6ed4be | - |
| feedback-8cb9ce7a3fed5d5739c91b169a385dd9 | active | feedback | cycle:vspi-tui-v1 | cycle.vspi-tui-v1.feedback.7aeaa2e55cb17cbd | - |
| feedback-8d2214604b348e7175b229e01cffedce | active | feedback | cycle:vspi-v0-2-0-workflow-integration | cycle.vspi-v0-2-0-workflow-integration.feedback.db56b25af6649ab5 | - |
| feedback-972bc2fd9775070a373aa12596ac4448 | active | feedback | cycle:vspi-terminal-mock-recovery | cycle.vspi-terminal-mock-recovery.feedback.ec72d6a2023bd6f4 | - |
| feedback-9cbc9f1c205a32a3455b2328c2c4e31a | active | feedback | cycle:vspi-v0-1-0-usability | cycle.vspi-v0-1-0-usability.feedback.a8cc7b4a225d894c | - |
| feedback-a48b3363d40d3c1d583cb0b182121e66 | active | feedback | cycle:vspi-tui-v1 | cycle.vspi-tui-v1.feedback.68c2739abc2b5cb2 | - |
| feedback-a707294349349d72544d7bd53c5cb6d3 | active | feedback | goal:vspi-persistent-goal-runner | goal.vspi-persistent-goal-runner.feedback.200f1ed19a14d67e | - |
| feedback-ab1742539cee36f0f27b27c36c48aad2 | inactive (superseded) | feedback | project:VSPi | feedback.vspi.status-layout-fixed-tracks | feedback-c9b3e339c6c3f13935ced61f6fe90114 |
...
| feedback-da6226ef6e521d26d9d0450ff05b4db0 | active | feedback | cycle:vspi-tui-v1 | cycle.vspi-tui-v1.feedback.4f0a53dac508ca81 | - |
| feedback-db31efd26e2215b19a90826d64584e69 | inactive (superseded) | feedback | delivery:vspi-v0-1-0-usability | feedback.vspi.status-layout-fixed-tracks | feedback-44198afddd97a657ea2cdab8cd574ed3 |
| feedback-dc147863d143b0fbd2fb60550d0d6596 | active | feedback | goal:vspi-live-run-control | goal.vspi-live-run-control.feedback.5ae10d550e18b724 | - |
| feedback-e0edd86b26f822b6af1a07d5f5fc0569 | active | feedback | goal:vspi-persistent-goal-runner | goal.vspi-persistent-goal-runner.feedback.02b3dd429995fd7f | - |
...
| requirement-4ec7c0718ad2d8da33763e040c25d2b6 | inactive (superseded) | requirement | project:VSPi | requirement.vspi.interactive-panel-density | requirement-67fde9f993577eb71275eead9f9c03cd |
| requirement-67fde9f993577eb71275eead9f9c03cd | inactive (superseded) | requirement | project:VSPi | requirement.vspi.interactive-panel-density | requirement-98835412db3b1cb35d3aacd8c4909f11 |
| requirement-7aa27ad8d6ea8ff47370425b826abd54 | active | requirement | project:project:VSPi | project_intent | - |
| requirement-80e6d448ecc68c4229ce7209ac7fbbad | active | requirement | project:VSPi | requirement.vspi.model-picker-recent | - |
| requirement-8fa3774fbc6fce3c20d507c1a0b55e90 | active | requirement | project:VSPi | requirement.vspi.skill-mcp-management | - |
| requirement-9714a3a81831cd03dec8943e06b51b8a | inactive (superseded) | requirement | project:VSPi | requirement.vspi.interactive-panel-density | requirement-358c59892ea47160bd195305ea3ecf13 |
