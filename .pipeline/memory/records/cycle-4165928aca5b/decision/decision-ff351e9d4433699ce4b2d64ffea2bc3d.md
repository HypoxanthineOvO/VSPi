...
id: decision-ff351e9d4433699ce4b2d64ffea2bc3d
kind: decision
schema_version: '1'
scope:
  ref: vspi-v0-2-0-workflow-integration
  type: cycle
semantic_hash: ff351e9d4433699ce4b2d64ffea2bc3dc373f4ef7d4a1d4bf05a866f0bd1254c
source_refs:
  - locator: compiled-plan
    ref: cycle:vspi-v0-2-0-workflow-integration:revision:3
    type: delivery_plan
supersedes:
  - decision-a023de2288f3238875f20e04f70dc948
updated_at: 2026-07-24T15:36:31.049Z
---
# VSPi v0.2.0 可用性优先与 Workflow 集成

先恢复可靠的原生工具、Host 审批、可中断 TUI 与合格的设置交互，再由真实试用决定 Workflow 的最终集成深度。
...
```json
{
  ...
  "milestones": [
    {
      ...
      "id": "M1",
      "order": 1,
      "outcome": "交付可真实试用的原生工具目录、自有 Question、独立审批器、ESC 分层取消以及合格的消息、Effort 与 Settings 交互。",
      "stone": {
        "acceptance_criteria": [
        ...
        "review": "真实启动 VSPi，试用文件/目录/搜索/图片/命令/编辑、五项审批、Question 与 ESC 分层退出，并检查用户消息、Effort 和 Settings 后决定是否进入 Workflow 架构阶段。"
      },
  ...
  "outcome": "先恢复可靠的原生工具、Host 审批、可中断 TUI 与合格的设置交互，再由真实试用决定 Workflow 的最终集成深度。",
  "revision": 3,
  "schema_version": "1",
  "status": "draft",
  "title": "VSPi v0.2.0 可用性优先与 Workflow 集成",
  "plan_hash": "4414110dd54f3d0547563e741a5e3195a94350773fd93988057f1b527971c43a"
}
```
